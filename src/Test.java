...
public class Test {
	...
	/**
	 * Error test: change main Android Type From To Assistant Fighter
	 * 
	 * Valid test: change main Android Type From To Associate Assistant Fighter
	 * Bodyguard
	 * 
	 * Error: Wrong Skin Assistant ArmoredSkin
	 * 
	 * Valid: Right Skin Assistant TouchSensitive
	 * 
	 * 
	 * Error: Wrong Security Level Assistant Level 3,4,5 Bodyguard Level 1,2,3,5
	 * Fighter Level 1,2,3,4
	 * 
	 * Valid: Right Security Level Associate Level 1 Assistant Level 1,2 Fighter
	 * Level 5 Bodyguard Level 4
	 * 
	 */
